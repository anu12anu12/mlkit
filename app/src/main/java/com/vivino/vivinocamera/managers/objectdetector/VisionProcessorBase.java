...
import com.vivino.vivinocamera.utils.BitmapUtils;
import com.vivino.vivinocamera.utils.CameraConstants;
import com.vivino.vivinocamera.utils.FrameMetadata;
import com.vivino.vivinocamera.utils.PreferenceUtils;
import com.vivino.vivinocamera.utils.ScopedExecutor;
import com.vivino.vivinocamera.utils.TemperatureMonitor;
import com.vivino.vivinocamera.view.CameraImageGraphic;
import com.vivino.vivinocamera.view.GraphicOverlay;
import com.vivino.vivinocamera.view.InferenceInfoGraphic;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    public void processBitmap(Bitmap bitmap, final GraphicOverlay graphicOverlay) {
        ...
        requestDetectInImage(
                ...
                graphicOverlay,
                /* originalCameraImage= */ null,
                /* shouldShowFps= */ CameraConstants.enableImageAnalysisDebugging,
                frameStartMs
        );
    }

    @Override
    public void processImage(final InputImage image, @NonNull final GraphicOverlay graphicOverlay) {
        long frameStartMs = SystemClock.elapsedRealtime();
        requestDetectInImage(
                image,
                graphicOverlay,
        ...
        return task.addOnSuccessListener(
                ...
                results -> {
                    ...
                    if (originalCameraImage != null) {
                        graphicOverlay
                                .add(new CameraImageGraphic(graphicOverlay, originalCameraImage));
                    }
